...
\label{3tierarch}
\begin{figure}
	\centerline{\includegraphics[scale=0.5]{3tier.png}}
...
\label{spa}
\begin{figure}
	\centerline{\includegraphics[scale=0.4]{spa.png}}
...
\label{hdf}
\begin{figure}
	\centerline{\includegraphics[scale=0.4]{hdf.png}}
	\caption{The contents of an HDF file}
	\label{hdf}
\end{figure}
\begin{figure}
	\centerline{\includegraphics[scale=0.5]{dset.png}}
