...
let {getUserProjects,getHDFPlot,getHDFArray,getHDFContentsForView,
    confProject,searchRelatedPosts,save_data}= helperConstructor;
...
function getDataFromPlotID(req,cb) {
    let new_plot = [];
        ...
        readObjs('posts',{_id:plot[0].inpost})((err,post) => {
            ...
            readObjs('datasets',{_id:post[0].dset_link})((err,dset) => {
                ...
                let obj={direction:direction,currystart:currystart,curryend:curryend,zoomstart:zoomstart,
                    zoomend:zoomend,dim1:dim1,dim2:dim2,dim3Value:dim3Value,dim2Value:dim2Value,path:plot[0].array_path_saved};
